...
//        }
//
//        assertEquals("<html><body>text1=asdf&text2=zxcv</body></html>", testServerResponse);
//    }
...
//    }
    ...
    public void isImageTest() {
        assert(new Task(new Socket(), "Test").isImage("jpg"));
        assert(!(new Task(new Socket(), "Test").isImage("invalid")));
    }
}